    ...
    <Fragment>
      <div className='container'>
        <form
          ...
          className='w-full max-w-[540px] p-4 text-center mx-auto mt-20'
        >
          <h3 className='mb-3 text-3xl font-medium uppercase'>
            Đăng nhập tài khoản
          </h3>
          ...
          <div>
            <p className='underline text-primaryColor text-[15px] cursor-pointer mt-4 hover:opacity-80 transition-opacity'>
              Quên mật khẩu
            </p>

            <p className='mt-6 font-medium leading-[18px] text-textColor'>
              Bạn chưa có tài khoản? Vui lòng liên hệ admin để được cấp tài
              khoản truy cập.
            </p>
          </div>
        </form>
