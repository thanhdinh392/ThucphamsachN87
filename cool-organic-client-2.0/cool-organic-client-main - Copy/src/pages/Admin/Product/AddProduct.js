...
const AddProduct = () => {
  ...
  const handleZoomPreviewImage = (imageIndex) => {
    setCurrentImageUrl(imageUrlList[imageIndex]);
    setShowModal(true);
  };
  ...
  const handleAddProduct = async (values) => {
    ...
    try {
      ...
      console.log(error);
      toast.error('Thêm sản phẩm không thành công, Vui lòng thử lại sau!');
    }
    setIsLoading(false);
  };
  ...
  return (
    <div className='pb-10'>
      <h2 className='pt-8 pb-5 text-2xl font-semibold'>Thêm Sản Phẩm</h2>
      <form onSubmit={handleSubmit(handleAddProduct)}>
        ...
        <div className='flex gap-2 mb-2'>
          <div className='w-[246px]'>
            <label htmlFor='price' className='block mb-2 font-semibold ml-0.5'>
              Giá sản phẩm
            </label>
            <input
        ...
        <div className='flex gap-2 mb-2'>
          ...
          <div className='w-[246px]'>
            <label htmlFor='origin' className='block mb-2 font-semibold ml-0.5'>
              Xuất xứ
            </label>
            <input
              className='px-3 py-3 border-2 rounded-lg border-borderColor hover:border-primaryColor focus:border-primaryColor min-w-[246px]'
        ...
        <div className='flex gap-2 mb-2'>
          <div className='w-[246px]'>
            <label htmlFor='weight' className='block mb-2 font-semibold ml-0.5'>
        ...
        >
          {isLoading && <Loading className='h-[20px] w-[20px] mr-2' />}
