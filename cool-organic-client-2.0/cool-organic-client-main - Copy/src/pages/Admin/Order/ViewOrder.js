...
const ViewOrder = () => {
  ...
  useEffect(() => {
    const handleGetOrder = async () => {
      setIsLoading(true);
      try {
        const response = await orderApi.getOrderByOrderId(id);
              ...
              >
                ...
                <Modal.Body className='mb-5'>
                  <p className='text-lg leading-5'>
                    Bạn có chắc chắn muốn xóa đơn hàng này không? Sau khi xóa,
                    bạn sẽ không thể khôi phục lại thông tin đơn hàng này.
                  </p>
                  <span className='block mt-5'>
                    <span className='text-red-500'>*</span> Sau khi xóa đơn
                    hàng, khách hàng của bạn sẽ được thông báo rằng đơn hàng đã
                    bị hủy.
                  </span>
                </Modal.Body>
              ...
              >
                ...
                <Modal.Body className='mb-5'>
                  ...
                  <span className='block mb-10'>
                    <span className='text-red-500'>*</span> Sau khi cập nhật
                    trạng thái đơn hàng, khách hàng của bạn sẽ được thông báo về
                    sự cập nhật.
                  </span>
                </Modal.Body>
                <Modal.Footer className='pb-1.5'>
